...
public class OpenFigiIsinConverter {
    ...
    /**
     * The asset registry, for the TR-native crypto short-circuit: a coin is resolved (and
     * registered) by symbol rather than looked up in a hardcoded ticker map.
     */
    ...
    public OpenFigiIsinConverter(
        com.picsou.service.FinancialAssetService assetService, SymbolCatalogPort symbolCatalog) {
