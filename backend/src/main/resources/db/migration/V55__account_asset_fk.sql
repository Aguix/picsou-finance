-- V55: account references financial_asset by FK (asset_id) instead of carrying a ticker string,
-- mirroring the account_holding.asset_id change (V52).
--
...
-- no dedicated asset.
--
-- Same mint-from-existing-data approach as V52: register a PENDING/UNKNOWN financial_asset for every
