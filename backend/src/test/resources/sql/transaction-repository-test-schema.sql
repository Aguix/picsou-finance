...
CREATE TABLE transaction (
    ...
    fees            DECIMAL(20, 8),
    -- Mapped by Transaction (V82) and therefore present in every generated INSERT, even though
    -- no test here sets it: a missing column fails the statement, not just the assertion.
    reward_kind     VARCHAR(20)
);
