...
/**
 * The crypto portfolio, rendered inside the Accounts page's Crypto filter. Two levels of detail:
 ...
 * freshly imported account. Standing coin mappings are managed from the Asset registry (the
 * "Vérifier les liaisons" button in the Accounts header), not here.
 */
export function CryptoPortfolioSection() {
  ...
  function select(account: Account | null) {
    // Merge into the existing params so any sibling param survives the account switch.
    setSearchParams(
      (prev) => {
